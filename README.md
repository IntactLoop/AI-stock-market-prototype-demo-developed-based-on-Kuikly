...
| --- | --- | --- | --- | --- |
|   ![1](docs/股票详情.png)  |  ![2](docs/AI信号解读&买卖建议.png)   |   ![3](docs/持仓诊断.png)  |  ![4](docs/多种分析.png)   |  ![5](docs/AI问答.png)   |

|           AI早报              |          筛选股票               |   选股页面  | 
| ----------------------- | ----------------------- | --- |
| ![6](docs/AI早报.png) | ![7](docs/筛选股票.png) |   ![8](docs/选股页面.png)  |

|           股票对比              |            关键指数对比                 |  AI对比分析   | 
| ----------------------- | --------------------------- | --- |
| ![9](docs/股票对比.png) | ![10](docs/关键指数对比.png) |   ![11](docs/AI对比分析.png)  |
